...
class PortScannerApp(ctk.CTk):
    ...
    def build_ui(self):
        ...
        self.start_btn = ctk.CTkButton(
            ...
            fg_color=PRIMARY, command=self.start_scan
        )
        ...
        self.stop_btn = ctk.CTkButton(
            ...
            font=btn_font, height=45,
            fg_color="#EF4444", command=self.stop_scan
        )
        ...
        self.clear_btn = ctk.CTkButton(
            ...
            font=btn_font, height=45,
            fg_color="#64748B", command=self.clear_output
        )
        ...
        # Progress
        self.progress = ctk.CTkProgressBar(self.main, height=18)
